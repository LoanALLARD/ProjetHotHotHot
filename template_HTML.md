...
```html
<button id="alert-trigger">Déclencher l'alerte</button>
```
...
<template id="produit-template">
  ...
  <produit role="section">
    ...
    <slot name="conditionnement" class="description"
      >INFOS CONDITIONNEMENT</slot
    >
  </produit>
  <hr />
</template>
...
customElements.define(
  ...
  class extends HTMLElement {
    constructor() {
      super();
      const template = document.getElementById("produit-template").content;
